      ...
      if (sessionID != undefined){
        ...
        if (sessionTimeDiffSec > 86400){
          ...
          for (var file in form.jupsTmpFiles){
			fs.rename(form.jupsTmpFiles[file].path, path.join(form.uploadDirDef, form.jupsTmpFiles[file].name.replace('ö','oe').replace('ä','ae').replace('ü','ue').replace('è','e').replace('é','e').replace('ê','e').replace('Ö','oe').replace('Ä','ae').replace('Ü','ue').replace('È','e').replace('É','e').replace('Ê','e')), err => {
